...
await page.evaluate(() => {
  const S = window.__app.S; S.settings.unlockAll = true; S.settings.fakeToday = '2026-09-06'; S.xp = 190; S.gems = 260; S.streak = 1; S.lastActive = '2026-09-06'; S.longestStreak = 14;
...
await page.screenshot({ path: `${OUT}/y-progress-day1.png`, fullPage: true });
...
await page.screenshot({ path: `${OUT}/y-profile-day1.png` });
...
await page.screenshot({ path: `${OUT}/y-practice-day1.png` });
await browser.close();
console.log('done');
